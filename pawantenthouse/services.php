...
<li><select  id="optio"><option selected="Our Services">Our Services</option><option><a href="#">Wedding Planner</a></option><option>Pandal Decoration</option><a href="#all-gallery-heading-style-4"><option>Flower Decoration</option></a><option>Baloon Decoration</option><option>Videography & Photo</option><option>Musical Events</option><option>Birthday parties</option>
</select></li>
...
<!-- . .. .. ..  Start Services  section . . . . . -->
 ...
 <div class="services-img-details"> 
    <h1 id="all-gallery-heading-style-1">Catering</h1>
	 ...
	 <div id="addrs" > <h1 align="center" style="font-size:18px; color:#990000; margin-top:7px;"> Office Address.</h1><br><br/>
	<span>@ .</span><p>117/447 L-Block</p><p>Kakadev Kanpur Nagar</p><p>Near Gopala Tower...</p><span>@</span><p>Contact no..25435235, 5345635535</p></div>
 </div>
 <div class="services-img-details">
    <h1 id="all-gallery-heading-style-2">Wedding Planner</h1>
      <div id="booking"><p></p><p><a href="#all-gallery-heading-style">Booking Start...</a></p> </div>
     <div id="booking_img"><p><img src="images/dinner-decoration2.jpg"></img></p> </div>
  </div>
 <div class="services-img-details"> 
    <h1 id="all-gallery-heading-style-3">Pandal Decoration</h1>
     <div id="one_img"><p><img src="images/dinner-decoration2.jpg"></img></p></div>
	 <div id="addrs" > <h1 align="center" style="font-size:18px; color:#990000; margin-top:7px;"> </h1><br><br/>
	<span>@ .</span><p></p><p></p><span></span><p></p></div>
 </div>
 <div class="services-img-details">
   <h1 id="all-gallery-heading-style-4">Flower Decoration</h1>
      <div id="booking"><p></p><p></p> </div>
     <div id="booking_img"><p><img src="images/dinner-decoration2.jpg"></img></p> </div>
  </div>
 <div class="services-img-details">
    <h1 id="all-gallery-heading-style-5">Baloon Decoration</h1>
      <div id="booking"><p></p><p></p> </div>
     <div id="booking_img"><p><img src="images/dinner-decoration2.jpg"></img></p> </div>
  </div>
 <div class="services-img-details">
    <h1 id="all-gallery-heading-style-6">Videography & Photo</h1>
      <div id="booking"><p></p><p></p> </div>
     <div id="booking_img"><p><img src="images/dinner-decoration2.jpg"></img></p> </div>
  </div>
 <div class="services-img-details">
    <h1 id="all-gallery-heading-style-7">Musical Events</h1>
      <div id="booking"><p></p><p></p> </div>
     <div id="booking_img"><p><img src="images/dinner-decoration2.jpg"></img></p> </div>
  </div>
 <div class="services-img-details">
    <h1 id="all-gallery-heading-style-8">Birthday Parties</h1>
      <div id="booking"><p></p><p></p> </div>
     <div id="booking_img"><p><img src="images/dinner-decoration2.jpg"></img></p> </div>
  </div>
